# -*- coding: utf-8 -*-
from flask import render_template, request, current_app, url_for, flash, redirect, abort, make_response
from flask_login import current_user

from bluelog.blueprints import blog_bp
...
def index():
    ...
    per_page = current_app.config['BLUELOG_POST_PER_PAGE']  # 获取每页数量
    pagination = Post.query.order_by(Post.timestamp.desc()).paginate(page, per_page=per_page)
    posts = pagination.items  # 当前页纪录数
